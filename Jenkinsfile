...
pipeline {
    ...
    stages {
        ...
        stage('Build') {
            steps {
                echo 'Build the code using Maven as the build automation tool to compile and package the application. We made an update here!#1'
            }
        }

        stage('Unit and Integration Tests') {
            steps {
                echo 'Run unit tests using JUnit and integration tests using Selenium.  We made an update here #2'
            }
        }
